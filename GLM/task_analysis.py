...
# -*- coding: utf-8 -*-
"""
Run GLM timeseries analysis on single scan run and combine lower-level analyses 
to compute subject-level activity estimates using HCP pipelines TaskfMRIAnalysis
...
if __name__ == '__main__':
    ...
    subject_list = pd.read_csv('/nfs/z1/userhome/MaSai/workingdir/Motor_project/code/task_analysis_group/subject_list.csv', header=None).iloc[:8, 0].to_list()
